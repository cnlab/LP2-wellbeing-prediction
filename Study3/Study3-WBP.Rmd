...
df = read.csv(file.path(data_dir,"data/osf/WBP_Study3_Behavioral_Cleaned.csv"))
...
```{r}
items = read.csv(file.path(data_dir,"data/osf/WBP_Study3_Behavioral_Cleaned_items.csv"))
