...
###prep the text data 
text <- read_csv("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/data_text/wellbeing-prediction-text-long.csv")
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/embeddings/wellbeing-prediction-embeddings.rds")
```
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/SWLS_subscale.RDS")) {
  ...
  saveRDS(SWLS_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/SWLS_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  SWLS_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/SWLS_subscale.RDS")
}
...
SWLS_heat
```
### Satisfaction with Life Words Related to Overall Well-being

```{r eval=FALSE, fig.height=7, fig.width=7, include=FALSE}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/SDP/SWLS_SWLS_PWB_SDP.RDS")) {
  # If the file doesn't exist, perform the analysis
 SWLS_SWLS_PWB_SDP <- textProjection(
    words = text_embed$SWLS,
    word_embeddings = embeddings$texts$SWLS,
    word_types_embeddings = embeddings$word_types$SWLS,
    x = df$`SWLS mean`,
    y = df$`PWB mean`)
  # Save the results in an RDS file
  saveRDS(SWLS_SWLS_PWB_SDP, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/SDP/SWLS_SWLS_PWB_SDP.RDS")
} else {
  # If the file exists, load the results from the RDS file
  SWLS_SWLS_PWB_SDP <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/SDP/SWLS_SWLS_PWB_SDP.RDS")
}
# Filter the DataFrame based on your criteria
#stat sig words with freq > 10 

SWLS_SWLS_PWB <- textProjectionPlot(
  word_data = SWLS_SWLS_PWB_SDP,
  k_n_words_to_test = FALSE,
  min_freq_words_test = 10,
  min_freq_words_plot = 10,
  plot_n_words_square = 10,
  plot_n_words_p = 10,
  ...
  y_axes = T,
  p_alpha = 0.05,
  title_top = "Supervised Dimension Projection:\nSWLS Responses ~~ Well-being Ratings (Entire Corpus)",
  x_axes_label = "Low vs High SWLS Scores",
  y_axes_label = "Low vs High PWB Scores",
  scale_x_axes_lim = NULL,
  scale_y_axes_lim = NULL,
  word_font = "Futura Medium",
  bivariate_color_codes = c("#398CF9", "#60A1F7", "#40DD52", 
                            "#e07f6a", "#EAEAEA","#5dc688", 
                            "#FF0000", "#EA7467", "#85DB8E"),
  word_size_range = c(2, 6),
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/autonomy_subscale.RDS")) {
  Autonomy_subscale <- textTrainLists(
   ...
   # Save the model output to an RDS file
  saveRDS(Autonomy_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/autonomy_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  Autonomy_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/autonomy_subscale.RDS")
}
...
### Autonomy Words Related to Overall Well-being

```{r eval=FALSE, fig.height=7, fig.width=7, include=FALSE}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/SDP/Autonomy_SWLS_PWB_SDP.RDS")) {
  # If the file doesn't exist, perform the analysis
 Autonomy_SWLS_PWB <- textProjection(
    words = text_embed$Autonomy,
    word_embeddings = embeddings$texts$Autonomy,
    word_types_embeddings = embeddings$word_types$Autonomy,
    x = df$`SWLS mean`,
    y = df$`PWB mean`)
  # Save the results in an RDS file
  saveRDS(Autonomy_SWLS_PWB, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/SDP/Autonomy_SWLS_PWB_SDP.RDS")
} else {
  # If the file exists, load the results from the RDS file
  Autonomy_SWLS_PWB <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/SDP/Autonomy_SWLS_PWB_SDP.RDS")
}
# Filter the DataFrame based on your criteria
#stat sig words with freq > 10 

Autonomy_SWLS_PWB_SDP <- textProjectionPlot(
  word_data = Autonomy_SWLS_PWB,
  k_n_words_to_test = FALSE,
  min_freq_words_test = 10,
  min_freq_words_plot = 10,
  plot_n_words_square = 10,
  ...
  y_axes = T,
  p_alpha = 0.05,
  title_top = "Supervised Dimension Projection:\n Autonomy Responses ~~ Well-being Ratings (Entire Corpus)",
  x_axes_label = "Low vs High SWLS Scores",
  y_axes_label = "Low vs High PWB Scores",
  scale_x_axes_lim = NULL,
  scale_y_axes_lim = NULL,
...
Autonomy_SWLS_PWB_SDP$final_plot
```
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/embeddings/Text_Only_wellbeing-prediction-embeddings.rds")
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Text_Only_SWLS_subscale.RDS")) {
  SWLS_subscale <- textTrainLists(
    x = embeddings$texts$SWLS, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(SWLS_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Text_Only_SWLS_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  SWLS_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Text_Only_SWLS_subscale.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Text_Only_autonomy_subscale.RDS")) {
  Autonomy_subscale <- textTrainLists(
    x = embeddings$texts$Autonomy, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(Autonomy_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Text_Only_autonomy_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  Autonomy_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Text_Only_autonomy_subscale.RDS")
}
filtered_predictions <- na.omit(Autonomy_subscale$predictions[1:8])
Autonomy_subscale_predictions <- as.data.frame(filtered_predictions)
models <- c(colnames(Autonomy_subscale$predictions[1:8]))
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/embeddings/Audio_Only_wellbeing-prediction-embeddings.rds")
```
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Audio_Only_SWLS_subscale.RDS")) {
  SWLS_subscale <- textTrainLists(
    x = embeddings$texts$SWLS, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(SWLS_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Audio_Only_SWLS_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  SWLS_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Audio_Only_SWLS_subscale.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Audio_Only_autonomy_subscale.RDS")) {
  Autonomy_subscale <- textTrainLists(
    x = embeddings$texts$Autonomy, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(Autonomy_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Audio_Only_autonomy_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  Autonomy_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/well-being-prediction/models/prelim-analyses/Audio_Only_autonomy_subscale.RDS")
}
filtered_predictions <- na.omit(Autonomy_subscale$predictions[1:8])
Autonomy_subscale_predictions <- as.data.frame(filtered_predictions)
models <- c(colnames(Autonomy_subscale$predictions[1:8]))
...
ggplot(combined_data, aes(x = r, y = outcome, xmin = conf.int_low, xmax = conf.int_high, color = prompt, alpha = p.value < 0.05, shape = dataset, linetype = dataset)) +
