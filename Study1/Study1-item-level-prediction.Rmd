...
data = read.csv(file.path(data_dir,"well-being-prediction/data/osf/WBP_Study1_Cleaned.csv"))
...
affect_heat <- ggplot(affect_item_results, aes(x = prompt, y = SWLS, fill = correlation)) +
  ...
  geom_text(aes(label = round(correlation, 2), fontface = ifelse(p_value_corrected < 0.05, "bold", "plain")), color = "black", size = 10) +
