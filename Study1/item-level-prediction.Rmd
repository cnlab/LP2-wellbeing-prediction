...
if (!file.exists("affect_item_output.RDS")) {
  ...
  saveRDS(affect_item, "affect_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  affect_item <- readRDS("affect_item_output.RDS")
}
...
if (!file.exists("purpose_item_level_output.RDS")) {
 purpose_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(purpose_item, "purpose_item_level_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  purpose_item <- readRDS("purpose_item_level_output.RDS")
}
...
if (!file.exists("relationships_item_level_output.RDS")) {
 relationships_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(relationships_item, "relationships_item_level_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  relationships_item <- readRDS("relationships_item_level_output.RDS")
}
...
if (!file.exists("acceptance_item_output.RDS")) {
 acceptance_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(acceptance_item, "acceptance_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  acceptance_item <- readRDS("acceptance_item_output.RDS")
}
...
if (!file.exists("growth_item_output.RDS")) {
 growth_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(growth_item, "growth_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  growth_item <- readRDS("growth_item_output.RDS")
}
...
if (!file.exists("autonomy_item_output.RDS")) {
 autonomy_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(autonomy_item, "autonomy_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  autonomy_item <- readRDS("autonomy_item_output.RDS")
}
