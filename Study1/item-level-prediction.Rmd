...
```{r load-data}
df <- read_csv("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/surveys_scored/LP2_transcriptions_behavioral.csv")

embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/embeddings/study_1/all_embeddings.rds")
```
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/affect_item_output.RDS")) {
  ...
  saveRDS(affect_item, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/affect_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  affect_item <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/affect_item_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/purpose_item_level_output.RDS")) {
 purpose_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(purpose_item, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/purpose_item_level_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  purpose_item <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/purpose_item_level_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/relationships_item_level_output.RDS")) {
 relationships_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(relationships_item, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/relationships_item_level_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  relationships_item <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/relationships_item_level_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/acceptance_item_output.RDS")) {
 acceptance_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(acceptance_item, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/acceptance_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  acceptance_item <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/acceptance_item_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/growth_item_output.RDS")) {
 growth_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(growth_item, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/growth_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  growth_item <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/growth_item_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/autonomy_item_output.RDS")) {
 autonomy_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(autonomy_item, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/autonomy_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  autonomy_item <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_prediction/models/Study-1/Non-Content-Words/Item-level-analyses/autonomy_item_output.RDS")
}
