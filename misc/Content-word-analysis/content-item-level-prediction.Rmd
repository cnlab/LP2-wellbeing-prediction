---
title: "Content-Item-level-Prediction"
author: ""
date: "`r Sys.Date()`"
output:
  html_document:
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/content_affect_item_output.RDS")) {
  ...
  saveRDS(affect_item, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/content_affect_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  affect_item <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/content_affect_item_output.RDS")
}
...
scale_fill_gradient2(low =  "#9C89FF",                        
                       mid = "#FFFFCC",                       
                       high = "#c44536") +
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/purpose_item_level_content_output.RDS")) {
 purpose_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(purpose_item, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/purpose_item_level_content_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  purpose_item <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/purpose_item_level_content_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/relationships_content_item_level_output.RDS")) {
 relationships_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(relationships_item, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/relationships_content_item_level_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  relationships_item <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/relationships_content_item_level_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/acceptance_content_item_output.RDS")) {
 acceptance_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(acceptance_item, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/acceptance_content_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  acceptance_item <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/acceptance_content_item_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/growth_content_item_output.RDS")) {
 growth_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(growth_item, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/growth_content_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  growth_item <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/growth_content_item_output.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/autonomy_content_item_output.RDS")) {
 autonomy_item <- textTrainLists(
  ...
  # Save the model output to an RDS file
  saveRDS(autonomy_item, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/autonomy_content_item_output.RDS")
} else {
  # If the RDS file already exists, load the data from it
  autonomy_item <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Content-word-analysis/models/autonomy_content_item_output.RDS")
}
