---
title: "LP2-Subscale-level-Prediction"
author: ""
date: "`r Sys.Date()`"
output:
  html_document:
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/within_person_intervention/data_text/embeddings/study_1/all_embeddings.rds")
```
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/autonomy/autonomy_subscale_df.RDS")) {

autonomy_path <- "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/autonomy"
...
# Save the model output to an RDS file
  saveRDS(autonomy_results, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/autonomy/autonomy_subscale_df.RDS")
} else {
  # If the RDS file already exists, load the data from it
  autonomy_results <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/autonomy/autonomy_subscale_df.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/acceptance/acceptance_subscale_df.RDS")) {
...
# Save the model output to an RDS file
  saveRDS(accept_results, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/acceptance/acceptance_subscale_df.RDS")
} else {
  # If the RDS file already exists, load the data from it
  accept_results <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/acceptance/acceptance_subscale_df.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/affect/affect_results.RDS")) {
...
# Save the model output to an RDS file
  saveRDS(affect_results, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/affect/affect_results.RDS")
} else {
  # If the RDS file already exists, load the data from it
  affect_results <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/affect/affect_results.RDS")
}
```
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/growthgrowth_results.RDS")) {

growth_path <- "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/growth"
...
# Save the model output to an RDS file
  saveRDS(growth_results, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/growthgrowth_results.RDS")
} else {
  # If the RDS file already exists, load the data from it
  growth_results <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/growth/growth_results.RDS")
}
```
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/purpose/purpose_results.RDS")) {

purpose_path <- "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/purpose/"
...
# Save the model output to an RDS file
  saveRDS(purpose_results, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/purpose/purpose_results.RDS")
} else {
  # If the RDS file already exists, load the data from it
  purpose_results <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/purpose/purpose_results.RDS")
}
```
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/relations/relations_results.RDS")) {

relations_path <- "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/relations"
...
# Save the model output to an RDS file
  saveRDS(relations_results, "/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/relations/relations_results.RDS")
} else {
  # If the RDS file already exists, load the data from it
  relations_results <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/relations/relations_results.RDS")
}
```
...
if (!file.exists("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/all_subscales.RDS")) {
  
  
combined_df <- rbind(autonomy_results,accept_results, affect_results, growth_results, purpose_results, relations_results)


  saveRDS(combined_df,"/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/all_subscales.RDS")
} else {
  # If the RDS file already exists, load the data from it
  combined_df <- readRDS("/Users/stevenmesquiti/Desktop/LP2-wellbeing-pred/LP2-wellbeing-prediction/Subscale-Models/all_subscales.RDS")
}
...
ggplot(filtered_tsne_plot, aes(x, y, label = words)) +
  geom_text(nudge_y = 0.01, check_overlap = TRUE, color = "dodgerblue2") +  # Adjust nudge_y for label positioning
