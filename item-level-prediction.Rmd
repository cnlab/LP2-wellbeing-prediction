...
df = read.csv(file.path(data_dir,"/data_prediction/surveys_scored/LP2_transcriptions_behavioral.csv"))
...
model_dir = "/Users/sm9518/Library/CloudStorage/Dropbox"

rds_file_path <- file.path(model_dir, "/LP2-wellbeing-pred/LP2-wellbeing-prediction/item_level_analyses/affect_item_output.RDS") #update with the path to each model
...
rds_file_path <- file.path(model_dir, "/LP2-wellbeing-pred/LP2-wellbeing-prediction/item_level_analyses/purpose_item_level_output.RDS") 
...
rds_file_path <- file.path(model_dir, "/LP2-wellbeing-pred/LP2-wellbeing-prediction/item_level_analyses/relationships_item_level_output.RDS") 
...
rds_file_path <- file.path(model_dir, "/LP2-wellbeing-pred/LP2-wellbeing-prediction/item_level_analyses/acceptance_item_output.RDS") 
...
rds_file_path <- file.path(model_dir, "/LP2-wellbeing-pred/LP2-wellbeing-prediction/item_level_analyses/growth_item_output.RDS") 
...
rds_file_path <- file.path(model_dir, "/LP2-wellbeing-pred/LP2-wellbeing-prediction/item_level_analyses/autonomy_item_output.RDS") 
