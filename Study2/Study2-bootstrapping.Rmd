...
```{r}
model_dir = '~/Desktop/LP2-wellbeing-prediction/models/Study2/'

# Load predictions for both models
model1_predictions <- readRDS(file.path(model_dir,"SWLS_subscale.RDS"))
model2_predictions <- readRDS(file.path(model_dir,"SWLS_subscale.RDS"))
```
...
# Load predictions for both models
model1_predictions <- readRDS(file.path(model_dir,"autonomy_subscale.RDS"))
model2_predictions <- readRDS(file.path(model_dir,"autonomy_subscale.RDS"))
# Load predictions for both models
```
