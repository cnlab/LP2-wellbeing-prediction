...
```{r load-data}
df <- read_csv("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/data/LP2_Wellbeing-Prediction_Behavioral.csv")
...
###prep the text data 
text <- read_csv("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/data_text/wellbeing-prediction-text-long.csv")
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/embeddings/wellbeing-prediction-embeddings.rds")
```
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/SWLS_subscale.RDS")) {
  ...
  saveRDS(SWLS_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/SWLS_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  SWLS_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/SWLS_subscale.RDS")
}
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/SDP/SWLS_SWLS_SDP.RDS")) {
 ...
 SWLS_SWLS_PWB_SDP <- textProjection(
  ...
  saveRDS(SWLS_SWLS_PWB_SDP, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/SDP/SWLS_SWLS_SDP.RDS")
} else {
  # If the file exists, load the results from the RDS file
  SWLS_SWLS_PWB_SDP <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/SDP/SWLS_SWLS_SDP.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/autonomy_subscale.RDS")) {
  Autonomy_subscale <- textTrainLists(
   ...
   # Save the model output to an RDS file
  saveRDS(Autonomy_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/autonomy_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  Autonomy_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/autonomy_subscale.RDS")
}
...
```{r eval=FALSE, fig.height=7, fig.width=7, include=FALSE}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/SDP/Autonomy_SWLS_PWB_SDP.RDS")) {
  # If the file doesn't exist, perform the analysis
 Autonomy_SWLS_PWB <- textProjection(
    ...
    y = df$`PWB mean`)
  # Save the results in an RDS file
  saveRDS(Autonomy_SWLS_PWB, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/SDP/Autonomy_SWLS_PWB_SDP.RDS")
} else {
  # If the file exists, load the results from the RDS file
  Autonomy_SWLS_PWB <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/SDP/Autonomy_SWLS_PWB_SDP.RDS")
}
# Filter the DataFrame based on your criteria
#stat sig words with freq > 10 
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/embeddings/Text_Only_wellbeing-prediction-embeddings.rds")
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Text_Only_SWLS_subscale.RDS")) {
  SWLS_subscale <- textTrainLists(
    x = embeddings$texts$SWLS, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(SWLS_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Text_Only_SWLS_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  SWLS_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Text_Only_SWLS_subscale.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Text_Only_autonomy_subscale.RDS")) {
  Autonomy_subscale <- textTrainLists(
    x = embeddings$texts$Autonomy, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(Autonomy_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Text_Only_autonomy_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  Autonomy_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Text_Only_autonomy_subscale.RDS")
}
filtered_predictions <- na.omit(Autonomy_subscale$predictions[1:8])
Autonomy_subscale_predictions <- as.data.frame(filtered_predictions)
models <- c(colnames(Autonomy_subscale$predictions[1:8]))
...
embeddings <- read_rds("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/embeddings/Audio_Only_wellbeing-prediction-embeddings.rds")
```
...
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Audio_Only_SWLS_subscale.RDS")) {
  SWLS_subscale <- textTrainLists(
    x = embeddings$texts$SWLS, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(SWLS_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Audio_Only_SWLS_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  SWLS_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Audio_Only_SWLS_subscale.RDS")
}
...
```{r}
if (!file.exists("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Audio_Only_autonomy_subscale.RDS")) {
  Autonomy_subscale <- textTrainLists(
    x = embeddings$texts$Autonomy, #use satifaction with life
    y = df[2:9],
    force_train_method = "regression",
   ...
   # Save the model output to an RDS file
  saveRDS(Autonomy_subscale, "/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Audio_Only_autonomy_subscale.RDS")
} else {
  # If the RDS file already exists, load the data from it
  Autonomy_subscale <- readRDS("/Users/stevenmesquiti/Box Sync/CurrentProjects_Penn/LP2/well-being-prediction/models/prelim-analyses/Audio_Only_autonomy_subscale.RDS")
}
filtered_predictions <- na.omit(Autonomy_subscale$predictions[1:8])
Autonomy_subscale_predictions <- as.data.frame(filtered_predictions)
models <- c(colnames(Autonomy_subscale$predictions[1:8]))
