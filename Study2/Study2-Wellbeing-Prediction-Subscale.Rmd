...
text_pids = unique(text$pID)


common_pids <- intersect(text_pids, text_embed_pids)
cat("Number of pIDs in BOTH df and text_embed:", length(common_pids), "\n")
cat("\n")


text = text %>% 
  filter(pID %in% common_pids)


#write to csv 
write_csv(text, file.path(data_dir,"data/WBP_Study2_Text_cleaned.csv"))
...
result_list_swls <- list(
  SWLS_acceptance = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB self_acceptance`$results,
  SWLS_autonomy = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB autonomy`$results,
  SWLS_growth = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB personal_growth`$results,
  SWLS_purpose = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB purpose`$results,
  SWLS_relationships = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB positive_relations`$results,
  SWLS_PWB = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB mean`$results,
  SWLS_SWLS = SWLS_subscale$all_output$`embeddings$texts$SWLS_SWLS mean`$results,
  SWLS_mastery = SWLS_subscale$all_output$`embeddings$texts$SWLS_PWB environmental_mastery`$results
)
...
```{r}
rds_file_path <- file.path(data_dir, "models/Study2/autonomy_subscale.RDS")

if (!file.exists(rds_file_path)) {
  Autonomy_subscale <- textTrainLists(
    x = embeddings$texts$Autonomy,
    y = df[2:9],
    force_train_method = "regression",
    save_output = "all",
    method_cor = "pearson",
...
result_list_autonomy <- list(
  Autonomy_acceptance = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB self_acceptance`$results,
  Autonomy_autonomy = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB autonomy`$results,
  Autonomy_growth = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB personal_growth`$results,
  Autonomy_purpose = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB purpose`$results,
  Autonomy_relationships = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB positive_relations`$results,
  Autonomy_PWB = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB mean`$results,
  Autonomy_SWLS = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_SWLS mean`$results,
  Autonomy_mastery = Autonomy_subscale$all_output$`embeddings$texts$Autonomy_PWB environmental_mastery`$results
)
...
```{r all-heat, fig.height=6, fig.width=8}
