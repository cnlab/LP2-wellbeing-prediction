...
df = read.csv(file.path(data_dir,"data/osf/WBP_Study2_Behavioral_Cleaned.csv"))
...
text = read.csv(file.path(data_dir,"data_text/WBP_Study2_Text_cleaned.csv"))
...
items = read.csv(file.path(data_dir,'data/osf/WBP_Study2_items.csv'))
